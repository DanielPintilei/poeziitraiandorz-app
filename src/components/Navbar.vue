    ...
    <div class="navbar__icons-right">
      ...
      <div class="icon-picker-wrapper">
        ...
        >
          ...
          ></path>
          <path :fill="theme.accent" d="M0 20h24v4H0z"></path>
        </svg>
        <transition name="theme-picker">
          <theme-picker :themes="themes" v-if="themePickerToggled"></theme-picker>
        </transition>
      </div>
      <div
